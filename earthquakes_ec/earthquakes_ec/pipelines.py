...
class EarthquakesPipelineCSV(object):
    def __init__(self):
        self.files = {}
    ...
    def spider_opened(self, spider):
        ...
        # self.exporter.fields_to_export = ['date','episode','tuneweek_artist','tuneweek_song','link','image']
    ...
    def process_item(self, item, spider):
        required_fields = ['Mag']  # your list of required fields
...
class EarthquakesPipelineJSON(object):
